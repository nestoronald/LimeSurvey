...
$(document).ready(function()
{
    ...
    /*popover: asistente tecnico*/
    //$('[rel="popover"]').popover({
      //  	trigger:'manual',						
	//});
    //$(".fa-question-circle").appendTo("ff");
    /*pregunta 009*/      
    $("input#answer435437X15X242SQ002comment").attr("placeholder","Nro de personas");    
    $("input#answer435437X15X242SQ001comment").attr("placeholder","Nro de entidades");
    $("input#answer435437X15X242SQ003comment").attr("placeholder","Nro de servicios");
    $("input#answer723618X5X60SQ004comment").hide();
    /*pregunta 6.5.4*/
    $("#javatbd435437X15X237other .pull-left:nth-of-type(2) ").addClass("col-xs-6"); 
    $("#javatbd435437X17X266other .pull-left:nth-of-type(2) ").addClass("col-xs-6");
    $("#javatbd435437X17X265other .pull-left:nth-of-type(2) ").addClass("col-xs-6");
